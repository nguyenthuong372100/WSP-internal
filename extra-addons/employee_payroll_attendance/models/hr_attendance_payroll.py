...
class HrPayslip(models.Model):
    ...
    currency_rate_fallback = fields.Float(string="Fallback Currency Rate (USD to VND)", default=23000, help="Fallback rate for currency conversion if live rate is unavailable.")
    ...
    attendance_line_ids = fields.One2many(
        ...
        'payslip_id', string="Attendance Records", copy=False
    )    
    ...
    vendor_bill_id = fields.Many2one(
        'account.move', string="Vendor Bill", readonly=True, help="The vendor bill generated for this payslip."
    )
    ...
    def create(self, vals):
        ...
        if employee_id:
            ...
            self.env['payslip.attendance'].create_attendance_records( payslip_id=payslip.id, employee_id=employee_id, attendance_data=attendance_data
            )
